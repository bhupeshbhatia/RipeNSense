...
export class WasteReportComponent implements OnInit {
  ...
  displayedColumns = ['itemNo', 'sensorNo', 'installationDate', 'foodItemName',
    'totalProduce', 'wastedProduce', 'unsoldProduce', 'priceSaved']
  ELEMENT_DATA: Element[] = [
    {
      itemNo: 1, sensorNo: 'Banana-A1-01', installationDate: this.createDate(1, 1),
      foodItemName: 'Banana', totalProduce: 20, wastedProduce: 10, unsoldProduce: 10,
      priceSaved: 15
    },
    {
      itemNo: 2, sensorNo: 'Tomato-A1-01', installationDate: this.createDate(1, 1),
      foodItemName: 'Tomato', totalProduce: 20, wastedProduce: 10, unsoldProduce: 10,
      priceSaved: 15
    },
    {
      itemNo: 3, sensorNo: 'Orange-A1-01', installationDate: this.createDate(1, 1),
      foodItemName: 'Orange', totalProduce: 20, wastedProduce: 10, unsoldProduce: 10,
      priceSaved: 15
    },
    {
      itemNo: 4, sensorNo: 'Mango=A1-01', installationDate: this.createDate(1, 1),
      foodItemName: 'Mango', totalProduce: 20, wastedProduce: 10, unsoldProduce: 10,
      priceSaved: 15
    },
    {
      itemNo: 5, sensorNo: 'Peach-A1-01', installationDate: this.createDate(1, 1),
      foodItemName: 'Peach', totalProduce: 20, wastedProduce: 10, unsoldProduce: 10,
      priceSaved: 15
    },
    {
      itemNo: 6, sensorNo: 'Grapes-A1-01', installationDate: this.createDate(1, 1),
      foodItemName: 'Grapes', totalProduce: 20, wastedProduce: 10, unsoldProduce: 10,
      priceSaved: 15
    }
  ]
